                        ...
                        <table class="min-w-full w-full table-auto bg-white border border-gray-200" id="table1">
                            ...
                            <tbody>
                                ...
                                <tr class="hover:bg-gray-100">
                                    ...
                                    <td class="py-3 px-4 border-b border-gray-200">{{$vehicle->user->name}}</td>
                                    <td class="py-3 px-4 border-b border-gray-200">{{$vehicle->topic}}</td>
                                    <td class="py-3 px-4 border-b border-gray-200 break-words max-h-24 overflow-auto">{{$vehicle->description}}</td>
                                    <td class="py-3 px-4 border-b border-gray-200">{{$vehicle->location}}</td>
                                    <td class="py-3 px-4 border-b border-gray-200">{{$vehicle->phone}}</td>
                                    <td class="border-b border-gray-200">@if($vehicle->image)
                                        <img src="{{ asset('storage/' . $vehicle->image) }}" alt="item Image" width="100">
                                          @endif</td>
                                    <td class="py-3 px-4 border-b border-gray-200">{{$vehicle->category}}</td>
                                    <td class="py-3 px-4 border-b border-gray-200">{{$vehicle->price}}</td>
                                    ...
                                    <td class="py-3 px-4 border-b border-gray-200">
                                        ...
                                        <a href="{{route('vehicle_edit',$vehicle->id)}}" class="btn btn-outline-warning">update</a>
                                        <form action="{{route('user_vehicle_delete',$vehicle->id)}}" method="post">
                                            @csrf
                                            @method('delete')
