...
<body class="flex min-h-screen bg-gray-100">
  ...
  <div id="sidebar" class="w-64 h-screen bg-gray-800 text-white flex flex-col h-screen fixed" >
    ...
    <nav class="flex-1 p-2">
      <a href="{{ route('dashboard_user') }}" class="block py-2 px-4 rounded hover:bg-gray-700">Dashboard</a>
     <!-- <a href="#" class="block py-2 px-4 rounded hover:bg-gray-700"> post Advertisement</a> -->
     <a href="{{ route('user_view_post') }}" class="block py-2 px-4 rounded hover:bg-gray-700"> your Advertisement</a>
     <a href="{{ route('notification_user') }}" class="block py-2 px-4 rounded hover:bg-gray-700">notification</a>
     {{--
        ...
        <div class="dropdown-menu hidden absolute left-0 mt-2 w-48 bg-gray-800 rounded shadow-lg" aria-labelledby="dropdownMenuButton">
               ...
               <a class="block py-2 px-4 hover:bg-gray-700 text-white" href="{{route('user_view_vehicle')}}">Vehicle</a>
              <a class="block py-2 px-4 hover:bg-gray-700 text-white" href="{{route('user_view_phone')}}">Mobile phone</a>
              <a class="block py-2 px-4 hover:bg-gray-700 text-white" href="{{route('user_view_property')}}">Property</a>
              <a class="block py-2 px-4 hover:bg-gray-700 text-white" href="{{route('user_view_fashion')}}">Fashion</a>
