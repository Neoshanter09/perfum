...
<div class="flex-1 ml-64">
    <x-app-layout>
        ...
        <div class="container max-w-6xl mt-5 "><!--p-3 -->
            <div class="flex-1 p-4 bg-white"><!-- p-4-->
                                ...
                                <tr class="hover:bg-gray-100">
                                    ...
                                    <td class="py-3 px-4 border-b border-gray-200">
                                        <div class="flex justify-start space-x-2">
                                            <a href="{{route('fashion_edit',$fashion->id)}}" class="btn btn-outline-warning">update</a>

                                        
                                        <form action="{{route('user_fashion_delete',$fashion->id)}}" method="post">
                                            @csrf
                                            @method('delete')
