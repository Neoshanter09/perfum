              ...
              <div class="space-y-8">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <input type="text" name="topic" id="topic" required value="{{$subCategory->name}}"
                  ...
                  <div class="w-2/3">
                    ...
                    <select id="catergory" name="catergory"  class="mt-2 block w-full border border-gray-300 rounded-lg shadow-sm p-2 focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                      ...
                      <option value="{{$catergory->id}}"{{ $subCategory->catergory_id == $catergory->id ? 'selected' : '' }}>{{$catergory->name}}</option>
                     @endforeach
                    </select>
