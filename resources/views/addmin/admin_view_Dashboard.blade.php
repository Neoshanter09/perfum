...
<div class="flex-1 ml-64">
    <x-app-layout>
        <x-slot name="header">
            ...
            <!-- Row containing 4 colored boxes -->
            {{--
                    <!-- Box 1 -->
                    <div class="container mx-auto mt-4 p-3 border border-gray-300 rounded-lg shadow-md max-w-6xl">
                        ...
                        <div class="flex flex-wrap justify-between">
                            ...
                            <div class="w-1/6 bg-gray-800 text-white p-3 rounded-lg shadow-lg transition-transform transform hover:scale-105 m-[10px]">
                                ...
                                <p class="text-lg font-bold text-center">{{ $category->post_count }}</p>
                                @if($category->logo)
                                    ...
                                    <div class="bg-white p-3 rounded-lg shadow-md transform transition duration-300 hover:scale-105 hover:shadow-lg">
                                        <div class="flex items-center  justify-center space-x-4">
                                            ...
                                            <div>
                                                ...
                                                <p class="text-xs font-bold text-center">{{ $category->post_count }}</p>
                                            </div>
                                        </div>
                                    </div>
                                    @endforeach
        ...
        <div class="container  mt-5 max-w-6xl"><!--p-3 -->
                                ...
                                <tr class="hover:bg-gray-100">
                                    ...
                                    <td class="border-b border-gray-200">@if($add_create->image)
                                        <img src="{{ asset('storage/' . $add_create->image) }}" alt="item Image" width="100">
                                          ...
                                          <td class="border-b border-gray-200">@if($add_create->image2)
                                            <img src="{{ asset('storage/' . $add_create->image2) }}" alt="item Image" width="100">

                                            @endif</td>

                                            <td class="border-b border-gray-200">@if($add_create->image3)
                                                <img src="{{ asset('storage/' . $add_create->image3) }}" alt="item Image" width="100">
                                    ...
                                    <td class="py-3 px-4 border-b border-gray-200">
                                        <div class="flex justify-start space-x-2">
                                            <a href="{{route('add_category',$add_create->id)}}" class="btn btn-outline-success">approw</a>
                                             <a href="{{route('add_hold',$add_create->id)}}" class="btn btn-outline-warning">hold</a>
                                            <a href="{{route('add_rejected',$add_create->id)}}" class="btn btn-outline-danger">rejected</a>
                                        </div>
                                        </td>
                                </tr>
